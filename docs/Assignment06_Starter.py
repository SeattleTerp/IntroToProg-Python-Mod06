...
# RKramer,5.17.2021,Modified code to add I/O functions
# RKramer,5.18.2021,Modified code to add Processing functions
# RKramer,5.18.2021,Modified code for main body of script
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def write_data_to_file(file_name, list_of_rows):
        """ Writes task data from list of rows to file

        :param file_name: (string) with name of file being overwritten:
        :param list_of_rows: (list) you read from to fill file:
        :return: (list) of dictionary rows
        """
